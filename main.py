...
def game_core_v1(number):
    '''ѕросто угадываем на random ни как не использу€ информацию о больше или меньше.
       ‘ункци€ ѕринимает загаданное число и возвращает число попыток'''
    count = 0
    while True:
        count+=1
...
def game_core_v3(number):
    '''»спользуем метод делени€ отрезка пополам'''
    count = 0
    left_gr=0
    right_gr=101
